...
def run_new_analysis():
    ...
    sns.scatterplot(data=correlation_df, x='SAR_head', y='psSAR10g_eyes', hue='frequency_mhz', palette='viridis', s=100, ax=ax)
    ...
    sns.lineplot(data=avg_penetration_ratio, x='frequency_mhz', y='penetration_ratio', hue='scenario', marker='o', ax=ax)
