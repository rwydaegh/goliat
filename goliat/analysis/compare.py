        ...
        for metric in METRICS:
            ...
            for phantom in sorted(phantoms):
                ...
                ax.errorbar(
                    ...
                    markersize=4, capsize=2, capthick=1,
                    linewidth=1.5,
                )
            
            metric_name = metric.replace(" (mW/kg)", "").replace("_", " ")
        ...
        for idx, scenario in enumerate(SCENARIOS):
            ...
            for phantom in sorted(phantoms):
                ...
                ax.errorbar(
                    ...
                    label=label, color=color,
                    markersize=3, capsize=1, capthick=0.5,
                    linewidth=1,
                )
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Compare UGent and CNR SAR data from Excel files"
    )
    parser.add_argument(
        "--ugent-file",
        type=str,
