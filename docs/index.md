...
-   :material-rocket-launch-outline:{ .lg .middle } **Installation**
...
-   :material-robot-happy-outline:{ .lg .middle } **AI Assistant**

    ---

    Query the codebase and documentation using natural language. Get instant answers to your questions.

    [:octicons-arrow-right-24: Use Assistant](user_guide/ai_assistant.md)
...
The analysis command can generate a local LaTeX results report containing the
selected tables and plots. The repository also includes the curated
[PMB paper](https://github.com/rwydaegh/goliat/blob/master/papers/pmb/paper.pdf)
and its source package.
