...
class ProgressGUI(QWidget):
    ...
    def init_ui(self):
        ...
        self.timings_table.setHorizontalHeaderLabels([
            "Phase", "Subtask", "Mean (s)", "Median (s)", "Min (s)", "Max (s)",
            "10% (s)", "25% (s)", "75% (s)", "90% (s)"
        ])
    ...
    def _setup_time_remaining_plot(self):
        ...
        self.tr_ax.legend(loc='upper right', facecolor='#3c3c3c', edgecolor='#f0f0f0', 
    ...
    def _setup_overall_progress_plot(self):
        ...
        self.op_ax.legend(loc='lower right', facecolor='#3c3c3c', edgecolor='#f0f0f0', 
                      labelcolor='#f0f0f0', fontsize=10)
    ...
    def _update_piecharts(self):
        ...
        if phase_weights:
            ...
            ax0.text(0.5, 0.5, 'No data', ha='center', va='center',
                   fontsize=12, color='#f0f0f0', transform=ax0.transAxes)
            ax0.set_title('Phase Weights', fontsize=12, color='#f0f0f0', pad=10)
        ...
        for i, (phase, title) in enumerate(zip(phases, phase_titles), start=1):
            ...
            if subtask_data:
                ...
                ax.text(0.5, 0.5, 'No data', ha='center', va='center',
                       fontsize=12, color='#f0f0f0', transform=ax.transAxes)
                ax.set_title(title, fontsize=12, color='#f0f0f0', pad=10)
