                ...
                if dry_run:
                    ...
                    if pkl_path.exists():
                        try:
                            ...
                            has_whole_body_pkl = "whole_body_sar" in summary_results
                        except Exception:
                            pass
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Fix SAR field names in old result files based on bounding_box setting"
    )
    parser.add_argument(
        "--results-dir",
        type=str,
