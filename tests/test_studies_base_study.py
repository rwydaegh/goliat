...
def test_base_study_initialization(tmp_path, monkeypatch):
    ...
    # Mock dependencies
    with patch("goliat.studies.base_study.Config") as mock_config_class, \
         patch("goliat.studies.base_study.Profiler") as mock_profiler_class, \
         patch("goliat.studies.base_study.ProjectManager") as mock_pm_class:
