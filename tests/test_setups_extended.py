...
def test_phantom_setup_initialization():
    ...
    with patch("goliat.setups.phantom_setup.BaseSetup.__init__", mock_base_init), \
...
def test_material_setup_initialization():
    ...
    with patch("goliat.setups.material_setup.BaseSetup.__init__", mock_base_init), \
         patch.dict("sys.modules", {
...
def test_placement_setup_initialization():
    ...
    with patch("goliat.setups.placement_setup.BaseSetup.__init__", mock_base_init), \
         patch.dict("sys.modules", {
...
def test_source_setup_initialization():
    ...
    with patch("goliat.setups.source_setup.BaseSetup.__init__", mock_base_init), \
         patch.dict("sys.modules", {
             "s4l_v1": mock_s4l_v1,
